...
public slots:
   ...
   */
  void
  setPositionVisible(bool aIsVisible);
...
private:
   ...
   */
  void
  fillPath(QFile& aTextFile, QPainterPath* aMainPath, QPainterPath* aBurnPath = NULL);
