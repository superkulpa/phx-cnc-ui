    ...
    AXBaseWindow()
{
  ...
  connect(mLazerDirectionView, SIGNAL(directionChanged(LazerDirectionView::eMoveDirection)), this,
      SLOT(onDirectionChange(LazerDirectionView::eMoveDirection)));
  connect(mLazerVelocityView, SIGNAL(velocityChanged(eVelocity)), this,
...
void
CXLazerDirectionWindow::onUtils()
{
  if (mUtils == NULL)
  {
...
void
CXLazerDirectionWindow::onDirectionChange(LazerDirectionView::eMoveDirection aDirection)
{
  ...
  {
    if (aDirection == LazerDirectionView::E_Top || aDirection == LazerDirectionView::E_TopLeft
        || aDirection == LazerDirectionView::E_TopRight)
    {
      x = "-2";
    }
    else
  ...
  {
    if (aDirection == LazerDirectionView::E_TopLeft || aDirection == LazerDirectionView::E_Left
        || aDirection == LazerDirectionView::E_BottomLeft)
    {
      y = "-2";
    }
    else
...
void
CXLazerDirectionWindow::onVelocityChange(eVelocity aVelocity)
{
  String value;
...
void
CXLazerDirectionWindow::onUpSpeed()
{
...
void
CXLazerDirectionWindow::onDownSpeed()
{
  mUdpManager->sendCommand(Commands::MSG_SECTION_OPERATOR, Commands::MSG_CMD_FEED,
...
void
CXLazerDirectionWindow::onModeChange()
{
...
void
CXLazerDirectionWindow::StartCP()
{
  mIsRunning = true;
...
void
CXLazerDirectionWindow::onCommandReceive(const QString& aSection, const QString& aCommand, const QString& aValue)
{
