...
private:
   ...
   */
  void
  highlight(const QString& aText, const QString& aPattern, const QTextCharFormat& aFormat, int aCapNumber =
      0);
...
public:
  ...
  //! Деструктор.
  virtual ~CXIniSyntaxHighlighter();
...
private:
   ...
   */
  void
  highlight(const QString& aText, const QString& aPattern, const QTextCharFormat& aFormat);
...
public:
  ...
  //! Деструктор.
  virtual ~CXXmlSyntaxHighlighter();
