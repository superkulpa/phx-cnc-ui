...
Q_OBJECT
  public:
  static const QString remoteCatalog;
  public:
  //! Конструктор.
   ...
   */
  void
  setConnectData(const QString& aHost, quint16 aPort, const QString& aUser, const QString& aPassword);
   ...
   */
  void
  setLoadFilesData(const QString& aSaveDir, const QString& aRemoteDir = QString());
...
public slots:
   ...
   */
  void
  onFtpDownload(const QStringList& aFiles = QStringList());
...
private slots:
   ...
   */
  void
  onFtpCommandFinish(int id, bool aIsError);
   ...
   */
  void
  onListInfo(const QUrlInfo& aInfo);
   ...
   */
  void
  onDataTransferProgress(qint64 done, qint64 total);
...
private:
   ...
   */
  void
  onFtpError(const QString& aErrorText);
