...
signals:
   ...
   */
  void
  fileCreated(const QString& aMainFile, const QString& aMoveFile);
   ...
   */
  void
  fileManageCreated(const QString& aMainFile, const QString& aMoveFile);
   ...
   */
  void
  fileSaved(const QString& aFileName);

  /*!
   Сигнал об изменении в логе компиляции.
   */
  void
  compileTextChanged(const QString& aText);
