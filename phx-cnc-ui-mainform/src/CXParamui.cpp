...
{
	int res = QProcess::execute(QApplication::applicationDirPath() + "/baseClient.exe", QStringList() << "-f" << "techparams.ini" << "-t" << mType);
